                    ...
                    <tbody>
                        @foreach($to_reads as $to_read)
                            <tr>
                                ...
                                <button wire:click="edit({{ $to_read->id }})" class="bg-blue-500 hover:bg-blue-700 text-black font-bold py-2 px-4 rounded">Edit</button>
                                <button wire:click="delete({{ $to_read->id }})" class="bg-red-500 hover:bg-red-700 text-black font-bold py-2 px-4 rounded">Delete</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
